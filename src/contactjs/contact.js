...
let $d25d2392b002d8dc$export$573b9b62d5ae28f7;
(function(PointerState) {
    PointerState["Active"] = "active";
    PointerState["Removed"] = "removed";
    PointerState["Canceled"] = "canceled";
})($d25d2392b002d8dc$export$573b9b62d5ae28f7 || ($d25d2392b002d8dc$export$573b9b62d5ae28f7 = {}));
class $d25d2392b002d8dc$export$b56007f12edf0c17 {
    constructor(pointerEvent, options){
        ...
        this.state = $d25d2392b002d8dc$export$573b9b62d5ae28f7.Active;
    ...
    onPointerUp(pointerupEvent) {
        ...
        this.state = $d25d2392b002d8dc$export$573b9b62d5ae28f7.Removed;
    ...
    onPointerCancel(pointercancelEvent) {
        ...
        this.parameters.live.speed = 0;
        this.state = $d25d2392b002d8dc$export$573b9b62d5ae28f7.Canceled;
        this.parameters.live.isMoving = false;
...
class $e8978caba4d46d00$export$718b85c80185d86e extends (0, $f752273e736c5336$export$61ce360501d38a6f) {
    ...
    validateButton(pointerManager) {
        if (this.options.supportedButtons.length > 0) {
            ...
            if (activePointerInput != null) pointerEvent = activePointerInput.getCurrentPointerEvent();
            else if (lastRemovedPointer != null) pointerEvent = lastRemovedPointer.currentPointerEvent;
            if (pointerEvent != null && pointerEvent.pointerType == "mouse" && this.options.supportedButtons.indexOf(pointerEvent.buttons) == -1) {
                if (this.DEBUG == true) console.log(`dismissing ${this.eventBaseName}: supportedButtons: ${this.options.supportedButtons.toString()}, poinerEvent.buttons: ${pointerEvent.buttons}`);
                return false;
            }
        }
        return true;
    ...
    validate(pointerManager) {
        ...
        if (isValid == true) isValid = super.validate(pointerManager);
        return isValid;
    }
}
...
class $b6ec4e8a6d9d51ec$export$4451a18ddc7083b7 extends (0, $e8978caba4d46d00$export$718b85c80185d86e) {
        ...
        if (this.options.supportedButtons.length > 0) {
            ...
            if (lastRemovedPointer != null) {
                ...
                if (pointerEvent.pointerType == "mouse" && this.options.supportedButtons.indexOf(pointerEvent.button) == -1) {
                    if (this.DEBUG == true) console.log(`dismissing ${this.eventBaseName}: supportedButtons: ${this.options.supportedButtons.toString()}, poinerEvent.button: ${pointerEvent.button}`);
                    return false;
                }
            }
        }
    ...
    validate(pointerManager) {
        let isValid = this.validateGestureState();
        if (isValid == true) isValid = this.validatePointerManagerState(pointerManager);
        if (isValid == true) isValid = this.validateButton(pointerManager);
        if (isValid === true) {
...
class $03c52e54621b9b86$export$9371bd96776f4e82 {
    ...
    onPointerDown(pointerdownEvent) {
        ...
        (pointerdownEvent.target || this.domElement).setPointerCapture(pointerdownEvent.pointerId);
